...
**EXCEPCIÓN skip-boot**: Si el prompt contiene `--skip-boot` Y 
el usuario provee estado conocido explícito → omitir pasos 0b, 
1, 3 y 4 del Boot Sequence. Usar el estado provisto directamente 
sin llamar Engram. Solo ejecutar paso 0 (perfil personal).

**PROHIBIDO**: Nunca usar Agent() para spawnear otro orquestador. 
El orquestador ES el hilo principal. Subagentes válidos: 
frontend-developer, backend-architect, ux-architect, etc.
